...
caffe.set_mode_cpu()
net = caffe.Net('/nfs.yoda/xiaolonw/fast_rcnn/fast-rcnn-hha/scripts_255/pre_gan_ori/train.prototxt', caffe.TRAIN)
headfile = '/nfs.yoda/xiaolonw/torch_projects/weights4/head_r.txt'
f = open(headfile, 'r')

savename = '/nfs.yoda/xiaolonw/fast_rcnn/models_hha/pre_gan_ori/fast_rcnn_zero.caffemodel'
